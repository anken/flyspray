...
'error71'                 => 'Ihr Benutzerkonto wurde aufgrund zu vieler fehlgeschlagener Login-Versuche für %d Minuten gesperrt.',
...
'error101'                => 'Sie sind nicht zur Anzeige dieser Aufgabe berechtigt!',
'error102'                => 'Sie haben nicht die nötigen Zugriffsrechte um diese Aufgabe zu sehen. Haben Sie sich eingeloggt?',
...
'any'                     => 'Jede',
'useradded'               => 'Der Benutzer wurde der Gruppe hinzugefügt',
'addormoveusers'          => 'Einen oder mehrere Benutzer hinzufügen (oder verschieben, wenn möglich)',
'currentglobalgroups'     => 'Aktuelle globale Gruppen',
'dependencygraphfor'      => 'Abhängigkeitsgraph für',
'defaultsortcolumn'       => 'Standardmäßig sortieren nach',
'asc'                     => 'aufsteigend',
'desc'                    => 'absteigend',
'sendbackground'          => 'Benachrichtigungen im Hintergrund senden',
'reopenedby'              => 'Wiedergeöffnet von',
'openedtasks'             => 'Offene Aufgaben',
'closedtasks'             => 'Geschlossene Aufgaben',
'reopenedtasks'           => 'Wiedergeöffnete Aufgaben',
'assignedtasks'           => 'Neuer Aufgaben-Besitzer',
'digestfor'               => 'Dies ist eine wöchentliche Zusammenfassung für',
'senddigest'              => 'Sende Zusammenfassung an den Projekt-Manager',
'notifyblacklist'         => 'Benachrichtigungen deaktivieren',
'currentgroups'           => 'Aktuelle Gruppen',
'userremovedproject'      => 'Der Benutzer wurde vom Projekt entfernt',
'projectmanagers'         => 'Projekt-Manager',
'addmoretasks'            => 'Fügen Sie weitere Aufgaben dieser Art hinzu',
'showeventssince'         => 'Zeige Ereignisse seit',
'notes'                   => 'Notizen',
'mynotifications'         => 'Meine Benachrichtigungen',
'addnote'                 => 'Notiz hinzufügen',
'notesubject'             => 'Betreff',
'savednotes'              => 'Gespeicherte Notizen',
'enternotesubject'        => 'Bitte geben Sie einen Betreff für Ihre Notiz ein.',
'noteadded'               => 'Notiz wurde erfolgreich hinzugefügt.',
'confirmdeletenote'       => 'Sind Sie sicher, dass Sie diese Notiz löschen wollen?',
'notedeleted'             => 'Notiz wurde erfolgreich gelöscht.',
'updatenote'              => 'Notiz aktuallisieren',
'nosubject'               => '(Kein Betreff)',
'noteupdated'             => 'Notiz wurde aktuallisiert',
'allowanonuserlist'       => 'Anonyme Benutzer können die Benutzerliste sehen',
'viewuserlist'            => 'Benutzerliste ansehen',
'anonviewtasks'           => 'Anonyme Benutzer können Aufgaben sehen',
'lists'                   => 'Listen',
'listtype'                => 'Listentyp',
'basic'                   => 'Einfach',
'list'                    => 'Liste',
'ldapnotsupported'        => 'Die PHP-LDAP-Erweiterung ist nicht installiert. Die Benutzung von LDAP ist somit nicht möglich und Sie sehen keine Optionen dafür.',
'ldapenabled'             => 'LDAP aktiviert',
'ldapserver'              => 'LDAP-Server',
'ldapbasedn'              => 'Basis-DN',
'ldapuserkey'             => 'LDAP-Attribut "Benutzername"',
'ldapuser'                => 'Bind-DN',
'ldappassword'            => 'Passwort',
'ldap'                    => 'LDAP-Einstellungen',
'jabbernotsupported'      => 'Die PHP-XML-Erweiterung ist nicht installiert. Die Benutzung von Jabber ist somit nicht möglich.',
'tls'                     => 'TLS',
...
'fileaccess'              => 'Datei-Zugriff',
'fsversion'               => 'Flyspray-Version',
'database'                => 'Datenbank',
'files'                   => 'Dateien',
'extensions'              => 'Erweiterungen',
'functions'               => 'Funktionen',
'affects:/flyspray.conf.php'=> 'Sollte nur schreibbar sein, wenn der Upgrader benutzt wird.',
'affects:/cache'          => 'Der Schreibzugriff wird benötigt für Dokuwiki (wenn aktiviert) und zum Zwischenspeichern von Feed auf der Festplatte.',
'affects:/attachemts'     => 'Für Anhänge ist Schreibzugriff notwendig',
'affects:openssl'         => 'Keine SSL-/TLS-Unstützung für E-Mail und Jabber',
'affects:xml'             => 'Keine Jabber-Unterstützung',
'affects:shell_exec'      => 'Die Erstellung des lokalen Abhängigkeitsbaumes ist nicht möglich wenn DOT verfügbar ist.',
'affects:ldap'            => 'Keine LDAP-Unterstützung',
'affects:stream_socket_enable_crypto'=> 'Keine TLS-Unterstützung für Jabber',
'affects:dns_get_record'  => 'Google Talk kann nicht für Jabber-Benachrichtigungen genutzt werden',
'allitems'                => 'Alle Elemente',
'fields'                  => 'Felder',
'type'                    => 'Typ',
'notspecified'            => 'Nicht spezifiziert',
'state'                   => 'Status',
'roadmapfield'            => 'Die Roadmap basiert auf',
'versiontense'            => 'Versions-Spanne',
'defaultvalue'            => 'Standardwert',
'forcedefaulttip'         => 'Erzwinge den Standard-Wert für neue Aufgaben',
'forcedefault'            => 'Standard erzwingen',
'required'                => 'Erforderlich',
'duplicateres'            => 'Lösung für doppelte Aufgaben',
'unlimited'               => 'Unbegrenzt',
'fieldadded'              => 'Das Feld wurde erfolgreich hinzugefügt!',
'fieldsupdated'           => 'Die Felder wurden erfolgreich aktuallisiert!',
'listadded'               => 'Die Liste wurde erfolgreich hinzugefügt!',
'listsupdated'            => 'Die Listen wurden erfolgreich aktuallisiert!',
'taskalreadyclosed'       => 'Diese Aufgabe ist bereits geschlossen!',
'notedoesnotexist'        => 'Die ausgewählte Notiz existiert nicht!',
'errorocurred'            => 'Es ist ein Fehler aufgetreten',
'inputerror'              => 'Es ist ein Eingabefehler aufgetreten. Sie haben ungültige Aufgaben zu Flyspray gesendet, welche nicht verarbeitet werden können. Stellen Sie sicher, dass Sie gültige Daten senden. Ansonsten ist dies ein Software-Fehler.',
'permserror'              => 'Sie haben nicht die nötigen Zugriffsrechte um diese Seite zu sehen oder diese Aktion auszuführen',
'dberror'                 => 'Ein Datenbank-Fehler ist aufgetreten. Für weitere Informationen überprüfen Sie die folgenden Informationen.',
'internalerror'           => 'Ein interner Fehler ist aufgetreten. Für weitere Informationen überprüfen Sie die folgenden Informationen. Die Ursache ist ein Fehler in der Software oder ein unsachgemäß konfiguriertes System.',
'location'                => 'Ort',
'overrideuserlang'        => 'Benutzer-Spracheinstellungen überschreiben',
'preferredlanguage'       => 'Bevorzugte Sprache',
'flysprayresponse'        => 'Flyspray-Antwort',
'syntax'                  => 'Syntax',
'viewprivate'             => 'Zeige private Aufgaben',
'showcontact'             => 'Kontakt-Informationen anzeigen',
'isadmin'                 => 'Ist Administrator',
'massedit'                => 'Massenbearbeitung',
'editnote'                => 'Bitte beachten Sie, dass Sie möglicherweise nicht über ausreichende Berechtigungen verfügen, um alle Eigenschaften aller Aufgaben, die Sie ausgewählt haben, zu ändern. In diesem Falle werden die Änderungen nicht übernommen.',
'selectedtasks'           => 'Ausgewählte Aufgaben',
'applychanges'            => 'Änderungen übernehmen',
'masseditsuccessful'      => 'Massenbearbeitung erfolgreich.',
'notasksselected'         => 'Sie haben keine Aufgabe ausgewählt!',
'usernameoremail'         => 'Benutzername oder E-Mail-Adresse',
'editprivate'             => 'Aufgaben-Sichbarkeit bearbeiten',
'confidential'            => 'vertraulich',
'projectprefix'           => 'Projekt-Präfix',
'projectlevelid'          => 'Projekt-Level-ID',
'badprefix'               => 'Ungültiges Projekt-Präfix. Es wird bereits verwendet oder enthält nicht alphanumerische Zeichen.',
'searchindetails'         => 'Such-Details',
'activateuser'            => 'Aktiviere nichtregistriete Benutzer manuell (per Benutzername)',
'useractivated'           => 'Benutzer erfolgreich aktiviert',
'nounregistereduser'      => 'Es wurde kein nicht registrierter Benutzer mit diesem Namen gefunden',
'minpwsize'               => 'Das Passwort muss mindestens fünf Buchstaben lang sein.',
'passwordtoosmall'        => 'Das Passwort ist zu kurz!',
'accountwaslocked'        => 'Ihr Benutzerkonto wurde gesperrt weil zu viele fehlgeschlagene Loginversuche stattgefunden haben.',
'failedattempts'          => '%d fehlgeschlagene Logins.',
'changelogreso'           => 'Changelog-Lösung',
'changelogfor'            => 'Changelog für',
'nochangelog'             => 'Es sind keine "Changelog"-Daten verfügbar. Stellen Sie sicher, dass Sie eine Lösung im Projekt-Management-Bereich ausgewählt haben.',
'groupnotexist'           => 'Die gewählte Gruppe existiert in diesem Prokekt nicht!',
'inactivityclose'         => 'Schließe inaktive Aufgaben automatich nach',
'stopautoclose'           => 'Schließe inaktive Aufgaben nicht automatich',
'autoclosingstopped'      => 'Das automatiche Schließen von Aufgaben wurde erfolgreich angehalten.',
'taskautoclosedmsg'       => 'Diese Aufgabe wurde erfolgreich in den Automatisch-Schließen-Modus versetzt.',
'tasknotautoclosing'      => 'Diese Aufgabe wird nicht automatisch geschlossen.',
'pastpresent'             => 'Vergangenheit und Gegenwart',
'futurepast'              => 'Zukunft und Vergangenheit',
'presentfuture'           => 'Gegenwart und Zukunft',
'bounceaddress'           => 'Bounce-Adresse',
'select'                  => 'Auswählen',
'userselect'              => 'Benutzer auswählen',
'defaultusers'            => 'Standard-Benutzer',
'userecaptcha'            => 'Benutze reCAPTCHA',
'recaptchapublickey'      => 'Öffentlicher reCAPTCHA-Schlüssel',
'recaptchaprivatekey'     => 'Privater reCAPTCHA-Schlüssel',
'disabled'                => 'deaktiviert',
'author'                  => 'Autor',
'commitmessage'           => 'Nachricht übermitteln',
'revision'                => 'Revision',
'feedsandsvn'             => 'Feeds und SVN',
'svnurl'                  => 'Ort des SVN-Repositories',
'svnuser'                 => 'SVN-Benutzername',
'svnpassword'             => 'SVN-Passwort',
'svnlog'                  => 'SVN-Commit-Log',
'svnnoconnection'         => 'Die Verbindung zum SVN-Server konnte nicht hergestellt werden',
'searchforbugs'           => 'Aufgaben suchen',
'relatedcommits'          => 'Ähnliche Commits',
'relateditems'            => 'Ähnliche',
'viewsvn'                 => 'SVN-Commit-Nachrichten ansehen',
'variousperms'            => 'verschiedene',
'specialperms'            => 'Spezille Rechte',
'taskperms'               => 'Aufgaben',
'assignmentperms'         => 'Zuweisungen',
'commentperms'            => 'Kommentare',
'attachmentperms'         => 'Anhänge',
'ldapbindmethod'          => 'LDAP-Verbindungsmethode',
'ldapbinddn'              => 'Bind-DN + Rebind',
'ldapbindpw'              => 'Bind-Passwort',
'ldapanonymous'           => 'Anonym',
'ldapdirect'              => 'Direkt binden',
'mailheaders'             => 'Mail-Header',
'createnewfromthis'       => 'Erstelle eine neue Gruppe aus diesen Mitgliedern.',
'quicklinks'              => 'Quicklinks',
'globalemail'             => 'E-Mail für alle Benachrichtigungen',
'globaljabber'            => 'Jabber-ID für alle Benachrichtigungen',
'colorfield'              => 'Die Färbung basiert auf',
'toggleexpansion'         => 'Aufklappen, um Aufgaben-Details zu sehen',
'noresultsshort'          => 'Kein Ergebnis',
'export'                  => 'Export',
'iCal'                    => 'iCal',
'calendarexport'          => 'Kalender-Export (iCal)',
'csv'                     => 'CSV',
'mailtask'                => 'Zu welcher E-Mail-Adresse wollen sie diese Aufgabe senden?',
'moveup'                  => 'Hoch',
'movedown'                => 'Runter',
'moveleft'                => 'Links',
'moveright'               => 'Rechts',
'linktotask'              => 'Link zu dieser Aufgabe',
'emailtask'               => 'Diese Aufgabe als E-Mail versenden',
'syntaxplugins'           => 'Syntax-Plugins',
'cannotedittaskglobally'  => 'Eine Aufgabe konnte nicht in das globale Projekt verschoben werden. Sie hätten eigentlich auch nicht diese Gelegenheit bekommen sollen.',
'options'                 => 'Optionen',
'selectuser'              => 'Benutzer auswählen',
'usernotinglobalgroup'    => 'Dieser Benutzer ist in keiner globalen Gruppen. Dies ist aber erforderlich. Bitten berichtigen Sie Ihre Datenbank-Einträge.',
'ldapconerror'            => 'Konnte keine Verbindung zum LDAP-Server herstellen.',
'ldaperror'               => 'Ein LDAP-Fehler ist aufgetreten.',
'recentlyclosed'          => 'Kürzlich geschlossen',
'showasassignees'         => 'Zeige alle Zünständigen',
'changedby'               => 'Zuletzt verändert von',
'moveallof'               => 'Verschiebe alle Einträge von',
'movelistto'              => 'nach',
'merge'                   => 'zusammenführen',
'listsarethesame'         => 'Die ausgewählten Listen sind identisch und können nicht zusammengeführt werden.',
'listtypesnotequal'       => 'Die Ausgewählten Listen haben nicht den selben Typ.',
'listsmerged'             => 'Die Listen wurden erfolgreich zusammengeführt.',
'UTC'                     => 'UTC',
'ldaprealnamekey'         => 'LDAP-Attribut "Echter Name"',
'ldapemailkey'            => 'LDAP-Attribut "E-Mail-Adresse"',
);
